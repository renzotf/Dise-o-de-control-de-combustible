            ...
            <div class="page-header flex-wrap">
              ...
              <div class="header-right d-flex flex-wrap mt-2 mt-sm-0">
                ...
                <button type="button" class="btn btn-primary mt-2 mt-sm-0 btn-icon-text">
                  <i class="mdi mdi-account-multiple-plus"></i> Crear Nuevo Cliente </button>
              </div>
            </div>
              ...
              <div class="col-xl-12 stretch-card grid-margin">
                <div class="card">
                  <div class="card-body pb-0">
                    <h4 class="card-title mb-0">Información de Especialista</h4>
                  </div>
                    ...
                    <div class="table-responsive">
                      <table class="table custom-table text-dark">
                        ...
                        <tbody>
                          ...
                          <td>03/06/2022</td>
                          <td>Arturo Torrejón Fernández</td>
                          <td>El trabajo se concluyo con exito</td>
                          <td>Terminado</td>
                          <td>04/06/2022 04:16:25</td>    
